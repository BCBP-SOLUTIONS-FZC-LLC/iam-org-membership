...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.InternalProvisionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/internal/tenants/{id}": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Realm identity payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.InternalRealmPatchRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.InternalTenantRealmResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.InternalLocaleResponse"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
        ...
        "/internal/tenants/{id}/members/{user_id}": {
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.InternalMemberDeleteResponse"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Lifecycle payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.InternalMembershipPatchRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.InternalMembershipPatchResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/internal/tenants/{id}/seat-usage": {
            "get": {
                "security": [
                    {
                        "UserID": []
        ...
        "/internal/tenants/{id}/tenders/{tender_id}/assignee-override": {
            "post": {
                "security": [
                    {
                        "UserID": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.AssigneeOverrideRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.AssigneeOverrideResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                    ...
                    "422": {
                        "description": "assignee_ineligible",
                        "schema": {
                            "$ref": "#/definitions/http.ErrorResponse"
                        }
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.OperatorDepartmentCreateRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/http.OperatorDepartmentResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.OperatorDepartmentPatchRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.OperatorPlansListResponse"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.OperatorPlanPatchRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.OperatorPlanResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.OperatorFeatureFlagsRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "unknown_feature_flag | invalid_feature_value",
                        "schema": {
                            "$ref": "#/definitions/http.ErrorResponse"
                        }
                    },
        ...
        "/operator/tenants/{id}/reassign-owner": {
            "post": {
                "security": [
                    {
                        "UserID": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.OperatorReassignOwnerRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.OperatorReassignOwnerResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                    ...
                    "409": {
                        "description": "tenant_offboarded",
                        "schema": {
                            "$ref": "#/definitions/http.ErrorResponse"
                        }
                    },
                    "422": {
                        "description": "invalid_owner_candidate",
                        "schema": {
                            "$ref": "#/definitions/http.ErrorResponse"
                        }
                    }
        ...
        "/tenants/{id}": {
            "get": {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "AUTH-1..8 gate failed",
                        "schema": {
                            "$ref": "#/definitions/http.ErrorResponse"
                        }
                    },
                    "404": {
                        "description": "Row not visible (RLS returns 0 rows OR row absent)",
                        "schema": {
                            "$ref": "#/definitions/http.ErrorResponse"
                        }
                    }
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.TenantPatchRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "202": {
                        "description": "Accepted (T-15 deferred realm sync)",
                        "schema": {
                            "$ref": "#/definitions/http.TenantResponse"
                        }
                    },
        ...
        "/tenants/{id}/departments": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Catalog department UUID",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/http.TenantDepartmentActivatedResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/tenants/{id}/departments/{dept_id}": {
            "patch": {
                "security": [
                    {
                        "UserID": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.TenantDepartmentPatchRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "422": {
                        "description": "system_department_cannot_be_retired",
                        "schema": {
                            "$ref": "#/definitions/http.ErrorResponse"
                        }
                    }
        ...
        "/tenants/{id}/departments/{dept_id}/members": {
            "get": {
                "security": [
                    {
                        "UserID": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.DeptMemberListResponse"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
        ...
        "/tenants/{id}/departments/{dept_id}/members/{user_id}": {
            "put": {
                "security": [
                    {
                        "UserID": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.DeptMembershipPutRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.DeptMembershipAssignResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                    ...
                    "422": {
                        "description": "department_not_active_for_tenant",
                        "schema": {
                            "$ref": "#/definitions/http.ErrorResponse"
                        }
                    }
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.DeptMembershipRemoveResponse"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
                    ...
                    "409": {
                        "description": "workflow_resolution_required (§8.8.4)",
                        "schema": {
                            "$ref": "#/definitions/http.ErrorResponse"
                        }
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.GroupDeptMappingsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/tenants/{id}/group-mappings/tenant-roles": {
            "put": {
                "security": [
                    {
                        "UserID": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.GroupTenantRoleMappingsRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.GroupTenantRoleMappingsResponse"
                        }
                    },
                    "400": {
                        "description": "invalid_role (member barred)",
                        "schema": {
                            "$ref": "#/definitions/http.ErrorResponse"
                        }
                    },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.InvitationListResponse"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
        ...
        "/tenants/{id}/members": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Base64-encoded opaque cursor from previous response",
                        "name": "cursor",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.MembershipListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.InvitationCreateRequest"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        "description": "Pending row created + RP CreateInvitedUser dispatched",
                        "schema": {
                            "$ref": "#/definitions/http.InvitationResponse"
                        }
                    },
                    ...
                    "409": {
                        "description": "seat_limit_reached OR invitation_already_exists",
                        "schema": {
                            "$ref": "#/definitions/http.ErrorResponse"
                        }
                    },
                    "429": {
                        "description": "reinvite_too_soon OR invite_rate_limited",
                        "schema": {
                            "$ref": "#/definitions/http.ErrorResponse"
                        }
                    }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.MemberItemResponse"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.MembershipPatchRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.MembershipPatchResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.RolesPutRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.RolesReconcileResponse"
                        }
                    },
                    "400": {
                        "description": "invalid_role (TR-7)",
                        "schema": {
                            "$ref": "#/definitions/http.ErrorResponse"
                        }
                    },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.RoleLabelListResponse"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.RoleLabelPatchRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.RoleLabelResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "domain.InvitationDeptMapping": {
            ...
            "properties": {
                ...
                "level": {
                    "$ref": "#/definitions/domain.DeptRole"
                }
            }
        },
        "domain.RealmType": {
        ...
        "http.DepartmentListResponse": {
            ...
            "properties": {
                "items": {
                    "description": "Items is the collection of active departments for the tenant.",
                    "type": "array",
                    "items": {
        ...
        "http.DeptMemberListResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/http.DeptMemberListItem"
                    }
                }
            }
        },
        ...
        "http.DeptMembershipAssignResponse": {
            "type": "object",
            "properties": {
                "department_id": {
                    "type": "string",
        ...
        "http.DeptMembershipRemoveResponse": {
            "type": "object",
            "properties": {
                "department_id": {
                    "type": "string",
        ...
        "http.ErrorResponse": {
            ...
            "properties": {
                "active_workflows": {
                    "description": "ActiveWorkflows is populated on 409 workflow_resolution_required\nresponses (§8.8). Count of open workflows blocking the mutation.",
                    "type": "integer",
                    "example": 3
                },
                "allowed_actions": {
                    "description": "AllowedActions lists the P-26 resolution actions the caller may invoke.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    },
                ...
                "code": {
                    "description": "Code is a legacy alias for Error kept for backwards compatibility.",
                    "type": "string",
                    "example": "not_found"
                },
                "details": {
                    "description": "Details is populated with per-field errors for 422 validation failures.",
                    "type": "array",
                    "items": {
                ...
                "error": {
                    "description": "Error is the machine-readable error code (LLD §17 error taxonomy).",
                    "type": "string",
                    "example": "not_found"
                },
                "message": {
                ...
                "record_version": {
                    "description": "RecordVersion is populated on 409 optimistic_lock_conflict responses\nso the client can re-read and retry (CONC-4).",
                    "type": "integer",
                    "example": 5
                },
                "request_id": {
                    "description": "RequestID is the per-request UUID injected by platform-gincommon.",
                    "type": "string",
                    "example": "01H8XYZ0000000000000000000"
                },
                "status": {
                    "description": "Status is the HTTP status code echoed in the body.",
                    "type": "integer",
                    "example": 404
                },
                "trace_id": {
                    "description": "TraceID is the OTel W3C trace ID for cross-service correlation.",
                    "type": "string",
                    "example": "a3f1b2c8d4e5f60718293a4b5c6d7e8f"
                },
                "workflow_ids": {
                    "description": "WorkflowIDs is populated on 409 workflow_resolution_required responses.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "http.GroupDeptMappingsRequest": {
            "type": "object",
            "properties": {
                "mappings": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/http.GroupDeptMappingWire"
                    }
                }
            }
        },
        "http.GroupDeptMappingsResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
        ...
        "http.GroupDeptRoleMappingsRequest": {
            "type": "object",
            "properties": {
                "mappings": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/http.GroupDeptRoleMappingWire"
                    }
                }
            }
        },
        "http.GroupDeptRoleMappingsResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
        ...
        "http.GroupTenantRoleMappingWire": {
            "type": "object",
            "properties": {
                "keycloak_group_name": {
                    "type": "string"
        ...
        "http.GroupTenantRoleMappingsRequest": {
            "type": "object",
            "properties": {
                "mappings": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/http.GroupTenantRoleMappingWire"
                    }
                }
            }
        },
        "http.GroupTenantRoleMappingsResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
        ...
        "http.InternalMemberDeleteResponse": {
            "type": "object",
            "properties": {
                "removed": {
                    "type": "boolean",
        ...
        "http.InternalMembershipPatchRequest": {
            "type": "object",
            "properties": {
                "record_version": {
                    "type": "integer",
        ...
        "http.InternalMembershipPatchResponse": {
            "type": "object",
            "properties": {
                "record_version": {
                    "type": "integer",
        ...
        "http.InternalProvisionRequest": {
            "type": "object",
            "properties": {
                "default_locale": {
                    "description": "DefaultLocale is an optional BCP-47 locale (e.g. \"en-US\").",
                    "type": "string",
                    "example": "en-US"
                },
                "name": {
                ...
                "owner_user_id": {
                    "description": "OwnerUserID is the initial tenant_owner.",
                    "type": "string",
                    "format": "uuid"
                },
                "plan": {
                    "description": "Plan is the entitlement tier.",
                    "type": "string",
                    "enum": [
                        "starter",
                        "pro",
                ...
                "slug": {
                    "description": "Slug is the tenant slug (immutable once set).",
                    "type": "string",
                    "example": "acme"
                },
                "tenant_id": {
                    "description": "TenantID is the pre-allocated tenant UUID.",
                    "type": "string",
                    "format": "uuid"
                }
            }
        },
        "http.InternalRealmPatchRequest": {
            "type": "object",
            "properties": {
                "keycloak_shard": {
                    "type": "string",
        ...
        "http.InternalTenantRealmResponse": {
            "type": "object",
            "properties": {
                "realm_id": {
                    "type": "string"
        ...
        "http.InvitationCreateRequest": {
            ...
            "properties": {
                ...
                "initial_dept_mappings": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.InvitationDeptMapping"
                    }
                },
                "initial_tenant_roles": {
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "http.MemberItemResponse": {
            "type": "object",
            "properties": {
                "departments": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/http.DeptMemberView"
                    }
                },
                "record_version": {
                    "type": "integer"
        ...
        "http.OperatorDepartmentCreateRequest": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "http.OperatorDepartmentPatchRequest": {
            "type": "object",
            "properties": {
                "is_active": {
                    "type": "boolean"
        ...
        "http.OperatorDepartmentResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string",
        ...
        "http.OperatorFeatureFlagsRequest": {
            "type": "object",
            "properties": {
                "feature_flags": {
                    "type": "object",
        ...
        "http.OperatorPlansListResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
        ...
        "http.OperatorReassignOwnerRequest": {
            "type": "object",
            "properties": {
                "new_owner_user_id": {
                    "type": "string"
        ...
        "http.TenantDepartmentActivatedResponse": {
            "type": "object",
            "properties": {
                "department_id": {
                    "type": "string",
        ...
        "http.TenantDepartmentPatchRequest": {
            "type": "object",
            "properties": {
                "is_active": {
                    "type": "boolean"
        ...
        "http.TenantResponse": {
            ...
            "properties": {
                ...
                "realm_type": {
                    "$ref": "#/definitions/domain.RealmType"
                },
                "record_version": {
                    "type": "integer"
                },
        ...
        "http.ValidationError": {
            ...
            "properties": {
                "code": {
                    "description": "Code is the machine-readable violation code.",
                    "type": "string",
                    "example": "out_of_range"
                },
                "field": {
                    "description": "Field is the JSON path of the failing field.",
                    "type": "string",
                    "example": "mfa_freshness_seconds"
                },
                "message": {
                    "description": "Message is a human-readable explanation of the field violation.",
                    "type": "string",
                    "example": "must be between 60 and 900"
                }
            }
        }
    },
